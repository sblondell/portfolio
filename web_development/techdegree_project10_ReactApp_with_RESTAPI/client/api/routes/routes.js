    ...
    Courses.findById(req.params.id, (err, course) => {
        ...
        if (!course) {
            ...
            if (req.currentUser._id.toString() === course.user.toString()) { // Check to make sure the current user owns the course...
                ...
                course.estimatedTime = req.body.estimatedTime ? req.body.estimatedTime : null;
                course.materialsNeeded = req.body.materialsNeeded ? req.body.materialsNeeded : null;
